...
const TodoApp = () => {
    ...
    const handleTodoCreate = async () => {
        ...
        await addDocument("todo", todo); // Refactored with utility function
        setIsLoading(false);
        setTitle("");
        setDescription("");
        setStatus("pending");
    ...
    useEffect(() => {
        if (user) {
            // Refactored with utility function and added unsubscribe for cleanup
    ...
    const handleTodoDelete = async (id) => {
        if (window.confirm("Are you sure you wanna delete this todo?")) {
            await deleteDocument("todo", id); // Refactored with utility function
    ...
    const handleToggle = async (id, currentStatus) => {
        ...
        await updateDocument("todo", id, { status: newStatus }); // Refactored with utility function
        toast({
    ...
    const handleFieldChange = (id, field, value) => {
        ...
        updateDocument("todo", id, { [field]: value }); // Refactored with utility function
    };
